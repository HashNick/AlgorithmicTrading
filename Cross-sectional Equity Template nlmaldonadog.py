...
def make_pipeline():
    ...
    interest_winsorized = interest.winsorize(min_percentile=0.05, max_percentile=0.95)
    oExpense_winsorized = oExpense.winsorize(min_percentile=0.1, max_percentile=0.9)
